...
public class MyCommentView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recyclerViewMycommets);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        firebaseFirestore = FirebaseFirestore.getInstance();

        Query query = firebaseFirestore.collection("comments").whereEqualTo("nickname",nickname);
        ...
        backBtn = (FloatingActionButton)findViewById(R.id.fBtnBackMy);
